...
namespace BookManagerWpf.Services
{
    ...
    public class BooksService
    {
        ...
        public void Initialize()
        {
            ...
            dbService.ReadSomething();

            Books = dbService.ReadBooks();

            dbService.AddBook(new Book() { Isbn = 555, Title = "Tiere", AuthorFirstname = "Franziska", AuthorLastname = "Fuchs" });

            dbService.DeleteBook(555);
        }
